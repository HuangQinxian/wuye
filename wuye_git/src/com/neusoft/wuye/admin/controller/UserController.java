...
public class UserController {
	...
	public ResultMessage validate(@RequestParam String userid,@RequestParam String password,HttpSession session) throws Exception
	{
		if(us.validate(userid, password)){
			...
			return new ResultMessage("200", "验证系统操作员成功");
		}
		else{
			return new ResultMessage("500", "验证系统操作员失败");
		}		
	}
	//取得指定的系统操作员
	...
	public PageInfo<UserModel> getListByAllWithPage(@RequestParam(required=false,defaultValue="10") int rows,@RequestParam(required=false,defaultValue="1")int page) throws Exception
	{
